...
public class ListTreeView2 extends BillTreeView implements IAutoShowUpComponent, ITabbedPaneAwareComponent,BillItemHyperlinkListener{
	...
	public void initUI() {
		...
		setTreeColumnName("value");
		BillItem codeItem = getBillItem("value");
